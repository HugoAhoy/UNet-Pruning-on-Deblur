...
from network.namedlightLayers import *

class DenoiseNetV3(nn.Module):

    def __init__(self, inChannels, outChannels):
        super(DenoiseNetV3, self).__init__()
...
class DenoiseNetV2(nn.Module):

    def __init__(self, inChannels, outChannels):
        super(DenoiseNetV2, self).__init__()
        self.n_channels = inChannels
        self.n_classes = outChannels
...
class DenoiseNetV1(nn.Module):

    def __init__(self, inChannels, outChannels):
        super(DenoiseNetV1, self).__init__()
        self.n_channels = inChannels
        self.n_classes = outChannels
